...
| [0032](0032-japanese-webfont-loading.md) | 和文の Web フォントは preload を切り、ウェイトを画面に出る分だけ宣言する | 2026-09-08 | 採用 |
| [0033](0033-selection-listener-on-document.md) | 発話の選択は document のリスナで購読し、終わりの合図に touchend を足す | 2026-09-08 | 採用 |
