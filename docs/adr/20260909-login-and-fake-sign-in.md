# ログインを入れ、固定のユーザーを「Google を経ないサインイン」へ置き換える

- **状態**: supersede 済み（→ 20260915-login-and-fake-sign-in）
- **決定日**: 2026-09-09
- **関係する ADR**: 20260829-production-basic-auth, 20260830-invite-only-multi-user, 20260901-session-security, 20260906-auth-better-auth, 20260906-ownership-granularity, 20260902-ownership-before-auth
...
| 採らなかった案 | 採らなかった条件 |
|---|---|
| フェイク専用の許可リストを持つ | 照合が二箇所になり、20260901-session-security の決定 9 が経路を一本に絞った理由（述語を差し替える場所が一つで済む）が消える |
